    ...
    RedirectorUI.prototype = {
        ...
        drawUI: function() {
            if (this.addIcon && !document.getElementById("redirector-icon")) {
                // add icon
                let icon = document.getElementById("menu_ToolsPopup").appendChild(document.createElement("menu"));
                ...
                document.getElementById("redirector-icon").appendChild(menupopup);
                // add menu
                let xml = '\
                        <menuitem label="启用/停用" id="redirector-toggle" type="checkbox" autocheck="false" key="redirector-toggle-key" checked="' + this.state + '" oncommand="Redirector.toggle();" />\
                ...
                range.selectNodeContents(document.getElementById("redirector-menupopup"));
